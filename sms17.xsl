...
<xsl:template name="formatDate">
    ...
    <xsl:variable name="formattedDate" select="concat('Le ', format-number($date div 86400 + 1, '00'), '/', format-number(($date mod 31556926) div 2629743 + 1, '00'), '/', format-number(($date mod 31556926) mod 2629743 div 86400 + 1970, '00'), ' à ', format-number(($date mod 86400) div 3600, '00'), ':', format-number(($date mod 3600) div 60, '00'))"/>
